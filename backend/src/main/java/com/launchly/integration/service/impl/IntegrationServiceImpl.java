...
public class IntegrationServiceImpl implements IntegrationService {
    ...
    private final IntegrationConfigValidator integrationConfigValidator;
    ...
    public IntegrationResponse createIntegration(IntegrationCreateRequest request, Long userId) {
        ...
        integrationConfigValidator.validateConfig(request.type(), configStr);
    ...
    public IntegrationResponse updateIntegration(Long id, IntegrationCreateRequest request, Long userId) {
        ...
        integrationConfigValidator.validateConfig(integration.getType(), configStr);
