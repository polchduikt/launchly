...
const LoginPage: React.FC = () => {
  ...
  const rightContent = (
    <div className="w-full text-left">
      <div className="mb-8">
        <h1 className="font-['Anybody',sans-serif] font-black text-xl text-ink mb-2 uppercase tracking-tight">{t('auth.login.title', 'Business Login')}</h1>
        <p className="text-sm text-ink/70 font-bold">{t('auth.login.subtitle', 'Enter your credentials to access your workspace')}</p>
      </div>
