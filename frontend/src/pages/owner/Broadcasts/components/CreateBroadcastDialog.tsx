    ...
    >
      ...
      >
        <div className="px-6 py-4 border-b-2 border-ink flex items-center justify-between">
          <h3 className="font-['Anybody',sans-serif] text-lg font-black text-ink uppercase tracking-tight">{t('broadcast.dialog.create_title')}</h3>
          <button
            type="button"
            onClick={onClose}
        ...
        <form onSubmit={onSubmit} className="p-6 space-y-4">
          ...
          <div className="pt-4 border-t-2 border-ink/15 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={isCreating}
              className="flex items-center gap-1.5 px-5 py-2.5 text-xs font-black uppercase text-canvas bg-ink hover:bg-indigo-700 disabled:opacity-50 border-2 border-ink rounded-xl transition-all cursor-pointer"
            >
              {isCreating ? (
                <>
