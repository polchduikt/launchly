  ...
  <>
    ...
    >
      <nav className="flex-1 px-2 py-4 space-y-0.5 overflow-y-auto">
        ...
        >
          <span className="flex items-center gap-2"><MessageSquare size={15} /> All chats</span>
        ...
        <div className="pt-3">
          <div className="flex items-center justify-between px-3 py-1">
            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Labels</span>
        ...
        >
          <Heart size={15} className={sidebarTab === 'favorites' ? 'text-red-500 fill-red-500' : 'text-red-400'} /> Favorites
        </button>
      </nav>
