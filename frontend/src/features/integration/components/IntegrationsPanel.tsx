  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <PremiumIntegrationCard
        title="Connect Hotmart Account"
        name="Hotmart"
        description="Hotmart empowers digital entrepreneurs with a leading online platform for selling and promoting digital products."
        logo={
      ...
      <PremiumIntegrationCard
        ...
        name="ChatGPT"
        description="ChatGPT integration enables individuals to accomplish a wide range of tasks. The flexibility and intelligence allow handling various types of requests and offering personalized support."
        logo={
        ...
        hasApiSecret={true}
        stepText="Connect ChatGPT Account"
      ...
      <PremiumIntegrationCard
        ...
        name="Claude"
        description="Claude integration enables individuals to accomplish a wide range of tasks. The flexibility and intelligence allow handling various types of requests and offering personalized support."
      ...
      <PremiumIntegrationCard
        title="Connect DeepSeek Account"
        name="DeepSeek"
        description="DeepSeek integration enables individuals to accomplish a wide range of tasks. The flexibility and intelligence allow handling various types of requests and offering personalized support."
        logo={
      ...
      <PremiumIntegrationCard
        ...
        name="Gemini"
        description="Google Gemini integration enables individuals to accomplish a wide range of tasks. The flexibility and intelligence allow handling various types of requests and offering personalized support."
        logo={<SiGooglegemini className="w-12 h-12 text-blue-600" />}
        hasApiSecret={true}
        placeholder="Enter Gemini API Secret"
        onUpgrade={handleUpgradeClick}
      />

      {/* 7. MailChimp Integration */}
      <PremiumIntegrationCard
        title="Connect MailChimp Account"
        name="MailChimp"
        description="The integration provides you with an ability to save customers contacts from Manychat to MailChimp. Learn more"
        logo={<SiMailchimp className="w-12 h-12 text-black" />}
        stepText="Connect MailChimp Account"
        onUpgrade={handleUpgradeClick}
      />
      ...
      <PremiumIntegrationCard
        ...
        name="HubSpot CRM"
        description="HubSpot CRM is everything you need to organize, track, and nurture your leads and customers. It's 100% free, forever. Learn more"
        logo={<SiHubspot className="w-12 h-12 text-[#FF7A59]" />}
        stepText="Connect HubSpot Account"
        onUpgrade={handleUpgradeClick}
      />
    </div>
  );
