    ...
    <div className="bg-canvas border-2 border-ink rounded-3xl p-6 md:p-8 flex flex-col md:flex-row gap-6 md:items-start justify-between transition-all font-['JetBrains_Mono',monospace]">
      ...
      <div className="w-full md:w-2/5 flex gap-4 items-start">
        ...
        <div className="flex-1 flex flex-col gap-2">
          <span className="font-black text-ink text-sm uppercase">Hotmart</span>
          ...
          <div className="space-y-1 mt-1">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                readOnly
                value={webhookUrl}
                className="w-full px-3 py-2 border-2 border-ink rounded-xl text-[11px] font-mono font-bold bg-white text-ink select-all focus:outline-none"
              />
              <button
                type="button"
                onClick={handleCopyWebhook}
                className="p-2 border-2 border-ink rounded-xl bg-white hover:bg-ink hover:text-canvas transition-colors shrink-0 cursor-pointer"
          ...
          {isConnected ? (
            <div className="space-y-3 w-full mt-2">
              <div className="p-3 bg-white border-2 border-ink rounded-xl text-xs font-bold text-ink">
