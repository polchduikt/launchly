              ...
              <div className="absolute left-14 bottom-[-40px] w-72 bg-white border border-slate-200 rounded-3xl shadow-2xl z-50 p-4 space-y-4 animate-in slide-in-from-left-2 duration-150 text-left">
                ...
                <div className="space-y-3 pt-1">
                  <div className="flex items-center justify-between px-2">
                    <span className="text-xs font-bold text-slate-700">Add sign-in options</span>
                    <div className="flex items-center gap-2">
                      <button className="w-6 h-6 rounded-full border border-slate-200 hover:border-slate-300 bg-white flex items-center justify-center cursor-pointer transition-all shadow-sm">
                      ...
                      <button className="w-6 h-6 rounded-full border border-slate-150 bg-slate-50/50 flex items-center justify-center cursor-not-allowed transition-all opacity-40 grayscale select-none">
